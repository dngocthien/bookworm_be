...
public class BookwormApplication {
    ...
    @Bean
    CommandLineRunner run(BookService bookService, CategoryService categoryService, AuthorService authorService) {
        return args -> {
//            Category
